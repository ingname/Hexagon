...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet(u"background-color: rgb(150, 248, 255);\n"
"border-color: rgb(185, 163, 126);")
        ...
        self.tl_button.setStyleSheet(u"background-color: rgb(75, 172, 179)")
        ...
        self.tr_button.setStyleSheet(u"background-color: rgb(75, 172, 179)")
        ...
        self.l_button.setStyleSheet(u"background-color: rgb(75, 172, 179)")
        ...
        self.r_button.setStyleSheet(u"background-color: rgb(75, 172, 179)")
        ...
        self.bl_button.setStyleSheet(u"background-color: rgb(75, 172, 179)")
        ...
        self.br_button.setStyleSheet(u"background-color: rgb(75, 172, 179)")
        ...
        self.save_game_button.setStyleSheet(u"background-color: rgb(75, 172, 179)")
        ...
        self.menu_button.setStyleSheet(u"background-color: rgb(75, 172, 179)")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tl_button.setText(QCoreApplication.translate("MainWindow", u"Вверх Налево", None))
        self.tr_button.setText(QCoreApplication.translate("MainWindow", u"Вверх Направо", None))
        self.l_button.setText(QCoreApplication.translate("MainWindow", u"Влево", None))
        self.r_button.setText(QCoreApplication.translate("MainWindow", u"Вправо", None))
        self.bl_button.setText(QCoreApplication.translate("MainWindow", u"Вниз Влево", None))
        self.br_button.setText(QCoreApplication.translate("MainWindow", u"Вниз Вправо", None))
        self.control_text.setText(QCoreApplication.translate("MainWindow", u"Контроль", None))
        self.label_player.setText("")
        self.label_text_player.setText(QCoreApplication.translate("MainWindow", u"Игрок:", None))
        self.save_game_button.setText(QCoreApplication.translate("MainWindow", u"Сохранить", None))
        self.menu_button.setText(QCoreApplication.translate("MainWindow", u"В меню", None))
