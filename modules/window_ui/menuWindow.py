...
"border-color: rgb(185, 163, 126);")
    ...
    def retranslateUi(self, StartWindow):
        ...
        self.new_button.setText(QCoreApplication.translate("StartWindow", u"Новая игра", None))
        self.ai_button.setText(QCoreApplication.translate("StartWindow", u"Игра с ИИ", None))
        self.load_button.setText(QCoreApplication.translate("StartWindow", u"Загрузить игру", None))
        self.scores_button.setText(QCoreApplication.translate("StartWindow", u"Счет", None))
