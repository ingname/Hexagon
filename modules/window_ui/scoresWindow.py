...
class Ui_ScoresWindow(object):
    def setupUi(self, ScoresWindow):
        ...
        ScoresWindow.setStyleSheet(u"background-color: rgb(150, 248, 255);\n"
"border-color: rgb(185, 163, 126);")
        ...
        self.nick_text_edit.setStyleSheet(u"background-color: rgb(75, 172, 179)")
        ...
        self.score_text_edit.setStyleSheet(u"background-color: rgb(75, 172, 179)")
    ...
    def retranslateUi(self, ScoresWindow):
        ...
        self.scoreboard_text.setText(QCoreApplication.translate("ScoresWindow", u"ЛУЧШИЙ СЧЕТ", None))
        self.nickname_text.setText(QCoreApplication.translate("ScoresWindow", u"Ник:", None))
        self.score_text.setText(QCoreApplication.translate("ScoresWindow", u"Счёт:", None))
